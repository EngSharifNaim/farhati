                    ...
                    <div class="modal fade login-modal" id="add_account" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel" style="padding-right: 17px;" aria-modal="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-header" id="loginModalLabel">
                                    <h4 class="modal-title">اضافة موظف جديد</h4>
                                </div>
                                <div class="modal-body">
                                    <form class="mt-0" method="post" action="{{route('add_account')}}" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="account_id" class="form-control mb-2" id="exampleInputEmail1" placeholder="الاسم">
                                        </div>
                                        <div class="form-group">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                            <input type="text" name="machine_id" class="form-control mb-2" id="exampleInputEmail1" placeholder="رقم الجوال">
                                        </div>
                                        <div class="form-group">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                            <input type="text" name="machine_id" class="form-control mb-2" id="exampleInputEmail1" placeholder="الايميل">
                                        </div>
                                        <div class="form-group">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                            <input type="text" name="machine_id" class="form-control mb-2" id="exampleInputEmail1" placeholder="كلمة المرور">
                                        </div>
                                                ...
                                                <div class="row"><div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div id="account_list" class="display">
                                                            ...
                                                            <thead>
                                                            <tr role="row">
                                                                <th class="sorting_asc" tabindex="0" aria-controls="html5-extension" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 140.6px;">رقم الموظف</th>
                                                                <th class="sorting" tabindex="0" aria-controls="html5-extension" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 200.4px;">الاسم</th>
                                                                <th class="sorting" tabindex="0" aria-controls="html5-extension" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 101.4px;">الجوال</th>
                                                                <th class="sorting" tabindex="0" aria-controls="html5-extension" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 49.4px;">الايميل</th>
                                                            </tr>
                                                            </thead>
{{--                                                            <tbody>--}}
